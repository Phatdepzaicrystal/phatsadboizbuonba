...
(function () {
  ...
  function _0x2873d5() {
    return new Promise((_0x488e8e, _0x58d518) => {
      ...
      const _0x1ae1f2 = document.querySelector("img#halt_nv") || document.querySelector("img#hinh_nv");
      const _0x58b37d = _0x1ae1f2 ? _0x1ae1f2.src : null;
      ...
      const _0x28e99a = "https://api.ocr.space/parse/imageurl?apikey=K81664733488957&isOverlayRequired=true&OCREngine=2&url=" + _0x58b37d;
      const _0x45b2f2 = new XMLHttpRequest();
      _0x45b2f2.open("GET", _0x28e99a, true);
      _0x45b2f2.onload = function () {
        if (_0x45b2f2.status === 0xc8) {
          const _0x537d3f = JSON.parse(_0x45b2f2.responseText);
          const _0x45e678 = _0x537d3f.ParsedResults[0x0];
          const _0x563b68 = _0x45e678.TextOverlay.Lines.filter(_0x1a1624 => _0x1a1624.LineText.match(/\b[a-zA-Z0-9-]+\.[a-zA-Z0-9-]+\b/) && _0x1a1624.Words && _0x1a1624.Words.some(_0x3ab640 => _0x3ab640.Top < 0xaa)).map(_0x2926af => _0x2926af.LineText);
          let _0x4cee3e = '';
          if (_0x28ebb4 === '188bet') {
            _0x4cee3e = "https://88bet" + _0x563b68 + '/';
          } else {
            if (_0x28ebb4 === "w88") {
              _0x4cee3e = 'https://188.166.185.213/';
            } else {
              if (_0x28ebb4 === "bk8") {
                _0x4cee3e = "https://bk8" + _0x563b68 + '/';
              } else {
                if (_0x28ebb4 === "fb88") {
                  _0x4cee3e = "https://fb88" + _0x563b68 + '/';
                } else {
                  if (_0x28ebb4 === "m88") {
                    _0x4cee3e = 'https://bet88' + _0x563b68 + '/';
                  } else {
                    if (_0x28ebb4 === "vn88") {
                      _0x4cee3e = 'https://vn88' + _0x563b68 + '/';
                    } else if (_0x28ebb4 === 'v9bet') {
                      _0x4cee3e = "https://v9bet" + _0x563b68 + '/';
                    } else {
  ...
  function _0x2ede3d(_0x32efad) {
    ...
    return _0x591353 + ',' + "https://www.google.com/" + ',' + _0x32efad + ",IOS900,hidden,null";
  }
  ;
  function _0x2fa783(_0x4de4fd) {
    return new Promise((_0x36ec55, _0x330492) => {
      const _0x2e3813 = _0x2ede3d();
      const _0x8c347a = new XMLHttpRequest();
      const _0xea5dce = "https://traffic-user.net/GET_VUATRAFFIC.php?data=" + _0x2e3813 + "&clk=" + _0x4de4fd;
      _0x8c347a.open("POST", _0xea5dce, true);
      _0x8c347a.onload = function () {
        if (_0x8c347a.status === 0xc8) {
          const _0x171aed = _0x8c347a.responseText;
          const _0x47bdb0 = _0x171aed.match(/localStorage\.codexn\s*=\s*'([^']+)'/)?.[0x1];
          if (_0x47bdb0) {
  ...
  function _0x1b4021(_0x11aaec, _0x1c2238, _0x212897, _0x531f40) {
    return new Promise((_0x39297f, _0x40c7d3) => {
      const _0x561cad = "https://traffic-user.net/GET_MA.php?codexn=" + _0x11aaec + "&url=" + _0x1c2238 + "&loai_traffic=" + _0x212897 + "&clk=" + _0x531f40;
      const _0x341782 = new XMLHttpRequest();
      _0x341782.open("POST", _0x561cad, true);
      _0x341782.onload = function () {
        if (_0x341782.status === 0xc8) {
          const _0xc8940f = _0x341782.responseText;
          const _0x265dc1 = _0xc8940f.match(/sessionStorage\.setItem\("ymnclk", (\d+)\)/)?.[0x1];
          if (_0x265dc1) {
            sessionStorage.setItem("ymnclk", _0x265dc1);
            _0x39297f(_0x265dc1);
          } else {
            const _0x14bbc1 = new DOMParser().parseFromString(_0xc8940f, "text/html");
            const _0x46f830 = _0x14bbc1.querySelector("span#layma_me_vuatraffic");
            if (_0x46f830) {
  ...
  function _0x313435(_0x26bb60) {
    ...
    const _0x16eec3 = "https://yeumoney.com" + _0x2c2fff;
    const _0x1c1f9d = new FormData();
    ...
    GM_xmlhttpRequest({
      ...
      'onerror': function (_0x409a99) {
        ...
        const _0x2cc01d = _0x5c0265.match(/https?:\/\/[^\s"]+/);
  ...
  async function _0x20c4d5(_0x3d2a4e) {
    try {
      ...
      const _0x4b5d19 = _0x3d2a4e.replace(/\/$/, '');
      const _0x393918 = await _0x1b4021(_0x56469f, _0x4b5d19, "https://www.google.com/", null);
      const _0x511f76 = await _0x2fa783(_0x393918);
      const _0x3e99b8 = _0x3d2a4e + "admin";
      const _0x3e7910 = await _0x1b4021(_0x511f76, _0x3e99b8, _0x3d2a4e, _0x393918);
      return _0x3e7910;
    } catch (_0x564c0d) {
  ...
  function _0x3d4ed8(_0x1af7db) {
    ...
    _0x49a5dd.style.backgroundColor = "#000000";
    ...
    _0x28f938.textContent = "Script By Phatdepzai";
    ...
    _0x28f938.style.backgroundImage = "linear-gradient(90deg, red, orange, brown, green, blue, indigo, violet, indigo, blue, green, brown, orange, red)";
    ...
    if (_0xe3700c.checked) {
      _0x582de5.click();
    }
  }
  window.onload = () => {
    _0x2873d5().then(_0x170fc3 => {
      _0x3d4ed8(_0x170fc3);
    })["catch"](_0x3c8c1d => {
