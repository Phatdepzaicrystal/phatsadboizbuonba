...
DoughKingEvent.OnServerEvent:Connect(function(player)
    ...
    if jobId and jobId ~= game.JobId then
        TeleportService:TeleportToPlaceInstance(2753915549, jobId, player)
    end
end)
