        ...
        while wait() do
            pcall(function()
                if (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88) then
                    v491:SetDesc("Mob: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 41) .. "");
                elseif (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87) then
                    v491:SetDesc("Mob: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 40) .. "");
...
local v499 = Tabs.Sever:AddParagraph({
...
local boss = Tabs.Main:AddSection("Boss Farm")
    ...
    if First_Sea then
		tableBoss = {"Raid Boss First Sea |","The Gorilla King","Bobby","Yeti","Mob Leader","Vice Admiral","Warden","Chief Warden","Swan","Magma Admiral","Fishman Lord","Wysper","Thunder God","Cyborg","Saber Expert"}
	elseif Second_Sea then
		tableBoss = {"Raid Boss Second Sea |","Diamond","Jeremy","Fajita","Don Swan","Smoke Admiral","Cursed Captain","Darkbeard","Order","Awakened Ice Admiral","Tide Keeper"}
	elseif Third_Sea then
		tableBoss = {"Raid Boss Third Sea |","Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake Queen"}
	end
...
---------------------------Tab Sea---------------------------------------
      ...
      local ToggleCollectAzure = Tabs.Fish:AddToggle("ToggleCollectAzure", {Title = "Collect Azure Ambers", Default = false })
...
if Second_Sea or Third_Sea then
    ...
    local ToggleTerrorshark = Tabs.Fish:AddToggle("ToggleTerrorshark", {Title = " Kill Terrorshark", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Fish:AddToggle("Togglelockmoon", {Title = "Lock Moon and Use Race Skill", Default = false })
                        ...
                        for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if (v.Name == "Baking Staff" or v.Name == "Head Baker" or v.Name == "Cake Guard" or v.Name == "Cookie Crafter") and v.Humanoid.Health > 0 then
                                repeat
                                    ...
                                    Tween(v.HumanoidRootPart.CFrame * Pos)  
                                    AttackNoCoolDown()  
                                until _G.CakePrice == false or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") or game:GetService("ReplicatedStorage"):FindFirstChild("Dough King") or not v.Parent or v.Humanoid.Health <= 0
                            end
                        end
                    else
                        bringmob = false
...
if Second_Sea then
    local ToggleSwordLengend = Tabs.Item:AddToggle("ToggleSwordLengend", {Title = "Buy Sword Lengendary",Default = false })
...
spawn(function()
    ...
    local ToggleStart = Tabs.Raid:AddToggle("ToggleStart", {Title = "Auto Start Raid [BETA]", Default = false })
...
local v134 = Tabs.Misc:AddToggle("ToggleEspRealFruit", {
    Title = "Esp Apple,Banana,Pineapple",
    Description = "Getting Ob V2",
    Default = false
});
ToggleEspRealFruit:OnChanged(function(v349)
    RealFruitEsp = v349;
