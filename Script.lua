...
if Second_Sea then
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Item:AddToggle("ToggleCakeV2", {Title = "Kill Dought King [Need Spawn]", Default = false })
...
if First_Sea then
	local ToggleSaber = Tabs.Item:AddToggle("ToggleSaber", {Title = "Auto Saber",Default = false })
...
local ToggleSharkSaw = Tabs.Item:AddToggle("ToggleSharkSaw", {Title = "Auto Saw",Default = false })
    ToggleSharkSaw:OnChanged(function(Value)
      _G.Auto_Saw = Value
end)
   Options.ToggleSharkSaw:SetValue(false)
