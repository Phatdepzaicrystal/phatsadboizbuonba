...
local Window = v28:Window(Enum.KeyCode.RightControl)
...
StatusTab:Button("Copy Link Discord", function()
    setclipboard("https://discord.gg/hyGgHBudcs")
end)

StatusTab:Seperator("Time")
...
StatusTab:Seperator("Player Status")

local RaceLabel = StatusTab:Label("Race")
spawn(function()
    while wait() do
        pcall(function()
...
local FragmentsLabel = StatusTab:Label("Fragments")
spawn(function()
    while wait() do
        pcall(function()
            FragmentsLabel:Set("Fragments: " .. game:GetService("Players").LocalPlayer.Data.Fragments.Value)
        end)
    end
end)

local BountyLabel = StatusTab:Label("Bounty")
spawn(function()
    while wait() do
        pcall(function()
            BountyLabel:Set("Bounty: " .. game:GetService("Players").LocalPlayer.leaderstats["Bounty/Honor"].Value)
        end)
    end
end)
