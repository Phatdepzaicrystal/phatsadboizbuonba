                ...
                pcall(
                    function()
                        ...
                        if (v806 and v806:FindFirstChild("HumanoidRootPart")) then
                            ...
                            if
                                (((v901 - Vector3.new(-6438.73535, 250.645355, -4501.50684)).Magnitude < 1) or
                                    ((v901 - Vector3.new(-5017.40869, 314.844055, -2823.0127)).Magnitude < 1))
                             then
                                v357 = {}
                            end
...
if Sea3 then
    ...
    local v522 = Tabs.Fish:AddToggle("ToggleTerrorshark", {
        Title = "Đấm Cá Mập",
    ...
    local v523 = Tabs.Fish:AddToggle("TogglePiranha", {
        Title = "Đấm Piranha",
    ...
    local v524 = Tabs.Fish:AddToggle("ToggleShark", {
        Title = "Đấm Cá Con",
    ...
    local v525 = Tabs.Fish:AddToggle("ToggleFishCrew", {
        Title = "Đấm Tàu Cá",
    ...
    local v526 = Tabs.Fish:AddToggle("ToggleShip", {
        Title = "Đấm Tàu",
    ...
    local v527 = Tabs.Fish:AddToggle("ToggleGhostShip", {
        Title = "Đấm Tàu Ma",
