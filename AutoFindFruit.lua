...
T.Text = "Auto Find Fruit-PhatCrystal"
...
NotificationLibrary:SendNotification("ZzzZzz", "Chờ xíu...", 10)
NotificationLibrary:SendNotification("zzzzzz", "thank you use taidepzai Hub", 10)
NotificationLibrary:SendNotification("zzzzzz", "https://discord.gg/TFmhmbGjEE", 10)
