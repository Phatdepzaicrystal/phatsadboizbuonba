loadstring(game:HttpGet(("https://raw.githubusercontent.com/VanThanhIOS/OniiChanVanThanhIOS/refs/heads/main/uimain.txt")))()
       ...
       local Window = MakeWindow({
         Hub = {
         Title = "Anime Hub",
         Animation = "Script Aimbot Player Săn Bounty"
         },
        Key = {
        KeySystem = false,
        Title = "By Hưng Thịnh/ Script Săn Bounty",
        Description = "",
        KeyLink = "https://anotepad.com/notes/g3gb9imd",
        Keys = {"Animehub"},
        Notifi = {
        Notifications = true,
       ...
       MinimizeButton({
       Image = "http://www.roblox.com/asset/?id=118640012534805",
       Size = {40, 40},
...
loackplayerslabel.Text = "Hưng Thịnh"
